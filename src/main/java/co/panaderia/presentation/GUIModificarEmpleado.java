...
public class GUIModificarEmpleado extends javax.swing.JFrame {
    ...
    public GUIModificarEmpleado() {
        ...
        if (GUIMenuAdmin.getUser() != null) {
            ...
            userName = GUIMenuAdmin.getUser().getCorreo();
        }
        if (GUIMenuEmpleados.getUser() != null) {
            userRol = GUIMenuEmpleados.getUser().getRol();
            userName = GUIMenuEmpleados.getUser().getCorreo();
        }
    ...
    private void jBtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnModificarActionPerformed
        ...
        if (jTxfEmail.getText().contains("@")) {
            try {
                ...
                Logger.getLogger(GUIModificarEmpleado.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIModificarEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIModificarEmpleado().setVisible(true);
            }
        });
    }
